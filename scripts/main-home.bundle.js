...
(0, _isomorphicFetch2.default)('https://geo-location.api.reimertz.co').then(function (response) {
...
document.querySelector('[data-night-mode-toggle]').addEventListener('click', function (e) {
